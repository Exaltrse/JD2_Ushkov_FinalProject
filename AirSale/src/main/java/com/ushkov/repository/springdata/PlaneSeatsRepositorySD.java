...
public interface PlaneSeatsRepositorySD
    ...
    List<PlaneSeats> findAllByPlaneAndDisabledIsFalse(Plane entity);

    List<PlaneSeats> findByPlaneAndSeatAndDisabledIsFalse(Plane planeEntity, SeatClass seatClassEntity);
