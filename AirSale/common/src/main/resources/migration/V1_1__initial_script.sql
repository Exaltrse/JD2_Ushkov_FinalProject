...
create unique index airline_plane_airline_plane_id_uindex
    on airline_plane (airline_plane_id);
...
create unique index flight_plane_flight_plane_id_uindex
    on flight_plane (flight_plane_id);
...
(
    ...
    current_flight_status integer not null,
    is_expired boolean default false not null,
...
create unique index user_passenger_user_passenger_uindex
    on user_passenger (user_passenger);
...
create unique index passenger_passport_passenger_passport_id_uindex
    on passenger_passport (passenger_passport_id);
